...
<html>
	...
	<body>
		<a href="#edit-solucao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-solucao" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:solucaoInstance, action:'update']" method="PUT" >
