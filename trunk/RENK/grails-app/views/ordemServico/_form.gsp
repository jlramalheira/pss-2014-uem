<%@ page import="renk.gerenciamentoServicos.OrdemServico" %>
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 ${hasErrors(bean: ordemServicoInstance, field: 'funcionario', 'error')} required">
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 ${hasErrors(bean: ordemServicoInstance, field: 'servico', 'error')} required">
        <label for="servico">
