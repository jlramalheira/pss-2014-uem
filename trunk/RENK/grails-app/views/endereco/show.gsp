		...
		<div id="show-endereco" class="content scaffold-show" role="main">
			...
			<ol class="property-list endereco">
				...
				<li class="fieldcontain">
					<span id="tipo-label" class="property-label"><g:message code="endereco.tipo.label" default="Tipo" /></span>
					
						<span class="property-value" aria-labelledby="tipo-label"><g:fieldValue bean="${enderecoInstance}" field="tipo"/></span>
