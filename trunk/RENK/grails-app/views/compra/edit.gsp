        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <section class="content col-xs-12 col-sm-9 col-md-9 col-lg-9">
                    <div id="edit-compra" class="scaffold-edit" role="main">
                        ...
                        <g:form url="[resource:compraInstance, action:'update']"
                            method="PUT" >
                            ...
                            <fieldset class="buttons">
                                ...
                                <g:link controller="show"  resource="${compraInstance}" 
                        ...
                        <div class="modal fade" id="modal-novo-produto" tabindex="-1" role="dialog" aria-labelledby="#modal-novo-produto-label" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <g:form id="new-item-form" url="[resource:compraInstance, action:'addProduct']">
