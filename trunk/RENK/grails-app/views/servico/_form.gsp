<%@ page import="renk.gerenciamentoServicos.Servico" %>
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-10 col-md-10 col-lg-10 ${hasErrors(bean: servicoInstance, field: 'nome', 'error')} required">
        <label for="nome">
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-10 col-md-10 col-lg-10 ${hasErrors(bean: servicoInstance, field: 'descricao', 'error')} ">
        <label for="descricao">
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3 ${hasErrors(bean: servicoInstance, field: 'hora', 'error')} required">
        <label for="hora">
    ...
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3 ${hasErrors(bean: servicoInstance, field: 'minutos', 'error')} required">
        <label for="minutos">
    ...
    <div class="row">
    <div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3 ${hasErrors(bean: servicoInstance, field: 'valor', 'error')} required">
        <label for="valor">
