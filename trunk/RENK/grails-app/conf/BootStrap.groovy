...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        Servico s = new Servico(nome: 'Formatar c/ backup', descricao: 'Instalar Linux', hora: 2, minutos: 0, valor: 50.00, quantidadeRealizado: 10)
        s.save()
        Servico s1 = new Servico(nome: 'Recarrega Preta', descricao: 'Recarregar cartucho HP Preto', hora: 0, minutos: 20, valor: 15.00, quantidadeRealizado: 55)
        s1.save()
        Servico s2 = new Servico(nome: 'Recarrega Color', descricao: 'Recarregar cartucho HP Colorido', hora: 0, minutos: 30, valor: 20.00, quantidadeRealizado: 30)
        s2.save()
        Servico s3 = new Servico(nome: 'Formatar s/ backup', descricao: 'Instalar Linux', hora: 1, minutos: 30, valor: 40.00, quantidadeRealizado: 5)
        s3.save()
        Servico s4 = new Servico(nome: 'Limpeza Cooler', descricao: 'Limpar e lubrificar', hora: 0, minutos: 30, valor: 20.00, ativo: false, quantidadeRealizado: 2)
        s4.save()
        ...
        prod.save()
        Produto prod1 = new Produto(codigoBarras: '7897725632615', nome: 'Mouse s/ fio', descricao: 'Mouse 1600DPI', estoqueMinimo: 3, estoqueDesejavel: 5,valorCusto: 40.00,  valorVenda: 59.90, valor: 59.90, ativo: true, saldo: 4, quantidadeComprado : 12, quantidadeVendido: 8)
        prod1.save()
        Produto prod2 = new Produto(codigoBarras: '7897725965874', nome: 'Teclado Satellite', descricao: 'Normas ABNT-2', estoqueMinimo: 2, estoqueDesejavel: 4, valorCusto: 25.00, valorVenda: 49.90, valor: 49.90, ativo: true, saldo: 2, quantidadeComprado : 6, quantidadeVendido: 4)
        prod2.save()
        Produto prod3 = new Produto(codigoBarras: '7897725632523', nome: 'Cartucho HP60 Preto', descricao: 'Compativel', estoqueMinimo: 4, estoqueDesejavel: 7, valorCusto: 19.90, valorVenda: 39.90, valor: 39.90, ativo: true, saldo: 7, quantidadeComprado : 20, quantidadeVendido: 13)
        prod3.save()
        Produto prod4 = new Produto(codigoBarras: '7897777885566', nome: 'Extensor USB', descricao: '', estoqueMinimo: 1, estoqueDesejavel: 2, valorCusto: 9.90, valorVenda: 19.90, valor: 19.90 , ativo: false, saldo: 0, quantidadeComprado : 1, quantidadeVendido: 1)
        prod4.save()
