...
class PerfilController {
    ...
    def save(Perfil perfilInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'perfilInstance.label', default: 'Perfil'), perfilInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'perfilInstance.label', default: 'Perfil'), params.id])
                redirect action: "index", method: "GET"
            }
